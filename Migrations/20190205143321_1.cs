        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LeagueImageUrl = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Leagues_Countries_CountriesId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TeamBadgeUrl = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Teams_Leagues_LeaguesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClubHistories_Leagues_LeaguesId",
                        column: x => x.LeaguesId,
                        principalTable: "Leagues",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ClubHistories_Seasons_SeasonsId",
                        column: x => x.SeasonsId,
                        principalTable: "Seasons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ClubHistories_Teams_TeamsId",
                        column: x => x.TeamsId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ManagerImageUrl = table.Column<string>(nullable: true),
                    CountryId = table.Column<int>(nullable: false),
                    CountriesId = table.Column<int>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Managers_Countries_CountriesId",
                        column: x => x.CountriesId,
                        principalTable: "Countries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Managers_Teams_TeamsId",
                        column: x => x.TeamsId,
                        principalTable: "Teams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BuiltIn = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClubHistories_LeaguesId",
                table: "ClubHistories",
                column: "LeaguesId");

            migrationBuilder.CreateIndex(
                name: "IX_ClubHistories_SeasonsId",
                table: "ClubHistories",
                column: "SeasonsId");

            migrationBuilder.CreateIndex(
                name: "IX_ClubHistories_TeamsId",
                table: "ClubHistories",
                column: "TeamsId");

            migrationBuilder.CreateIndex(
                name: "IX_Leagues_CountriesId",
                table: "Leagues",
                column: "CountriesId");

            migrationBuilder.CreateIndex(
                name: "IX_Managers_CountriesId",
                table: "Managers",
                column: "CountriesId");

            migrationBuilder.CreateIndex(
                name: "IX_Managers_TeamsId",
                table: "Managers",
                column: "TeamsId");
